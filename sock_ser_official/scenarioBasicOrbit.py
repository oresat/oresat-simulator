...
def run(show_plots, orbitCase, useSphericalHarmonics, planetCase):
    ...
    simTaskName = "simTask" #TODO change to something  more
    ...
    oe = orbitalMotion.ClassicElements() ##########hewp#############
    rLEO = 6871. * 1000      # meters - changes to 500 km from earth
